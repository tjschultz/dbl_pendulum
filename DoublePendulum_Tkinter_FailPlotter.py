...
# constants
G = 9.81 # m/s^2
N_COMP_PENDULUMS = 1 # set number of double pendulums to animate
...
class App(tk.Tk):
    ...
    def update_pendulum_pos(self, index):
        ...
        self.pendulums1[index].theta +=  p1.theta * self.dt
        self.pendulums2[index].thetadot += theta2dotdot * self.dt
        self.pendulums2[index].theta +=  p2.theta * self.dt
    ...
    def draw_frame(self):
        ...
        self.update_pendulum_pos(0)
        self.draw_pendulums(0)
