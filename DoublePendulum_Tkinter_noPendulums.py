...
class App(tk.Tk):
    ...
    def draw_pendulums(self, index):
        ...
        # draw the trace
        self.canvas.create_line(self.trace_coords[index], fill=self.colors[index], tag='trace', width=(5))
...
if __name__ == '__main__':
    ...
    for i in range(N_COMP_PENDULUMS):
        ...
        theta1 = (0.33 *m.pi) + random.randrange(10)/10000*i
        theta2 = (0.33 *m.pi) + random.randrange(20)/10000*i
